...
Sales Analytics Dashboard is a beginner-friendly data analytics project built using Python, Streamlit, Pandas, and Plotly.
...
This project was created primarily for learning and portfolio purposes.
Current limitations include:

Requires a specific dataset schema
Limited CSV compatibility
No database integration
No user authentication
No advanced forecasting or machine learning features
Designed for small to medium-sized datasets

Live Demo:
https://salesanalyst.streamlit.app/
